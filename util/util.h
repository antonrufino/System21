...
// Print application name in ASCII art generated by figlet.
void header() {
...
// Converts a category (str) to a number.
...
// Converts a number (n) to a category.
...
// Gets float input from user. Only allows positive numbers.
...
// Handles asking of category from users. Handles errors on its own.
...
// Gets y or n response from user.
